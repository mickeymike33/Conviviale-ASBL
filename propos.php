        ...
        <h2>Qui sommmes-nous ?</h2>         
            <h3 class="title is-3">L’équipe</h3>
                <p>
                    ...
                    Une trentaine de personnes sous contrat article 60 : bénéficiaires de l’aide sociale, engagées par leur CPAS et mises a la disposition de Convivial pendant une période determinée (18 mois en moyenne). 
                </p>
            <br>
                <p>
                    Convivial leur offre un cadre de travail et un accompagnement se voulant être un <strong>tremplin pour un nouvel emploi</strong> ;
                    Une vingtaine de personnes volontaires, à temps partiel.
                    Soit une équipe de plus de trentaine-cinq nationalités offrant la possibilité d’un accueil dans une langue familière à la plupart des bénéficiaires. Des Réfugiés se retrouvent dans tous les services, à tous les niveaux de responsabilité, comme salariés,
                    travailleurs sous contrat article 60 ou volontaires.
                </p>
            <figure class="image">
